...
data.fig <- read.csv("data_ROI_r5DLPFC.csv")
...
data.viol <- ggplot(data = data.fig, 
  ...
  scale_color_manual(values=c(rgb(89/255,103/255,199/255),rgb(89/255,103/255,199/255),
                              rgb(89/255,103/255,199/255)), name = "Group", 
...
fig.name <- paste("fig_r5DLPFC", ".", fig.fmt, sep = "")
