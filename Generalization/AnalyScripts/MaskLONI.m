...
mask_template=fmri_data(which('FF_cond_all_fdr05_30_roi.nii')); % this is a .nii file where all 6 MFC regions have a value of 1 and all other voxels are set to 0
